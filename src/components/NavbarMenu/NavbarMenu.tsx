                ...
                isOpen ? (
                    <ul className={className}>
                        ...
                        <div className='z-50 transition-all duration-700 animate-open absolute flex flex-col top-14 left-0 w-full dark:bg-slate-800 bg-slate-100 pt-5'>
                            {menuComponent}
                            <Button isSearch={false} isAdd={false} className='px-10 py-2 mx-5 mb-5 dark:border rounded-lg transition-all duration-500 bg-slate-900 dark:bg-transparent hover:bg-transparent hover:border hover:text-slate-900 hover:border-slate-900 text-white dark:hover:bg-white dark:hover:text-slate-800' text="S'inscrire" />
                        </div>
                    </ul>
                ) : (
                    <ul className={className}>
                        {menuComponent}
                        <Button isSearch={false} isAdd={false} className='hidden md:block px-10 py-2 ml-5 dark:border rounded-lg transition-all duration-500 bg-slate-900 dark:bg-transparent hover:bg-transparent hover:border hover:text-slate-900 hover:border-slate-900 text-white dark:hover:bg-white dark:hover:text-slate-800' text="S'inscrire" />
