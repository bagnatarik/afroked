    ...
    return (
        <>
            <div className='w-3/4 md:h-[750px] flex flex-col items-center justify-center'>
                ...
                <Button className='hidden md:block px-56 py-4 border transition-all duration-500 bg-slate-900 dark:bg-transparent hover:bg-transparent hover:border hover:text-slate-900 hover:border-slate-900 text-white dark:hover:bg-white dark:hover:text-slate-800' text="Commencer" />
            </div>
        </>
    )
}