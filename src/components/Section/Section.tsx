    ...
    return (
        <>
            <div className='hidden w-3/4 md:h-[750px] md:flex flex-col items-center justify-center'>
                ...
                <Button isAdd={false} className='hidden md:block px-56 py-4 border transition-all duration-500 bg-slate-900 dark:bg-transparent hover:bg-transparent hover:border hover:text-slate-900 hover:border-slate-900 text-white dark:hover:bg-white dark:hover:text-slate-800 rounded-lg' text="Commencer" />
            </div>
        </>
    )
}